...
pub use host_wrap::{
    ...
    get_account_contract, get_block_timne, get_data_keys, is_callable, load_asset,
    load_asset_typed, load_data, log, remove_asset, remove_data, s_call, sha256, store_asset,
    store_asset_typed, store_data, verify,
};
