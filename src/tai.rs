...
mod tests {
    ...
    const ASSET_FULL_LOCK_HEX: &str = "9264928102c08103c0";
    const ASSET_DEPOSIT_LOCK_HEX: &str = "9264928102c08101c0";
    const ASSET_WITHDRAW_LOCK_HEX: &str = "9264928102c08102c0";
